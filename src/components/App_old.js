  ...
  constructor(props){
    ...
    this.state = {
      ...
      contents:[
        ...
        {id:2, title:'Individual Results', subtitle:'An individual result', desc:'Customize displaying individual results. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.'},
        {id:3, title:'Sidebar', subtitle:'UI components of sidebar', desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.'},
        {id:4, title:'Suggestions', subtitle:'Suggestions of search box', desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.'},
...
//sidebar
  ...
  render(){
    const steps = [
      ...
      {name: '', component: <Sidebar title={this.state.contents[2].title} subtitle={this.state.contents[2].subtitle} 
      ...
      {name: '', component: <Suggestions title={this.state.contents[3].title} subtitle={this.state.contents[3].subtitle}
